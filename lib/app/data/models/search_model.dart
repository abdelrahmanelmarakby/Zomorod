...
class VideoThumbNail {
  ...
  VideoThumbNail({this.url, this.width, this.height});
...
class Thumbnails {
  ...
  Thumbnails.fromJson(Map<String, dynamic> json) {
    defaultThumb = json['default'] != null
        ? VideoThumbNail.fromJson(json['default'])
        : null;
    medium =
        json['medium'] != null ? VideoThumbNail.fromJson(json['medium']) : null;
    high = json['high'] != null ? VideoThumbNail.fromJson(json['high']) : null;
  }
